...
import { useCreateAccountStore } from "./CreateAccountZustand";

export default function CreateAccount() {
  const { postAccount } = useCreateAccountStore();
    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-4">
          {[
            { name: "name", type: "text", placeholder: "Name", delay: 80 },
            { name: "phone", type: "tel", placeholder: "Phone number", delay: 140 },
            { name: "email", type: "email", placeholder: "Email", delay: 200 },
            { name: "password", type: "password", placeholder: "Password", delay: 260 },
            {
            ...
            <div
              key={field.name}
              className="opacity-0 animate-fade-up"
              style={{ animationDelay: `${field.delay}ms`, animationFillMode: "forwards" }}
            >
              <input
                type={field.type}
